...
function CustomerTable({id, name, license, subscription, date,rowPressed, add, remove, detail, deactivate, detach }) {
  return (
          ...
          <td className="text-end">
            <Dropdown>
              ...
              <Dropdown.Menu variant="light">
                ...
                <Dropdown.Item onClick={deactivate}>Deactivate Account</Dropdown.Item>
