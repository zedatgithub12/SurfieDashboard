  ...
  <Row className="p-4 pb-0 ps-3">
    <h4 className="fw-semibold " >Customer Support</h4>
      ...
      <Row className="m-auto">
              ...
              {Data.length < 1 ? (
                ...
                Data.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span className="badge text-danger rounded-pill d-inline">
                        Active
                      </span>
                    </td>
                  </tr>
        ...
        >
             <div>
                <p className="fw-semibold mt-0 fs-6 text-secondary">Message Preview</p>
              </div>
          {modalContent.status? (
            <>
           ...
           <div className="d-flex justify-content-end align-items-center ">
             <Button variant="white" className="me-2 btn btn-md text-danger ">
               close
             </Button>
             <Button variant="white" className="me-2 btn btn-md text-primary ">
               Reply
             </Button>
           </div>
           </>
            ...
            <img src={text} alt="textnode" className="h-50 w-50 m-auto" fluid />
            </div>
            </div>
          )}
